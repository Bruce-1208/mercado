...
def get_reputation_info(window_id, site):
    ...
    data_color = driver.find_element(
        By.CLASS_NAME, "panel-segment__focus-item-title-container"
    ).text
