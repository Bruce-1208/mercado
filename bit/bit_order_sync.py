...
def _is_interpreter_shutdown_error(exc):
    """Return whether background work raced with Python interpreter exit."""
    message = str(exc or "").casefold()
    return _interpreter_shutting_down() or (
        isinstance(exc, RuntimeError)
        and "cannot schedule new futures after interpreter shutdown" in message
    )
