...
list_br = [
    "3857905067 Estimado servicio al cliente, se trata de una marca genérica de la máquina de juego, él es el juicio erróneo del sistema, por favor ayúdame a eliminar el registro de infracción, ¡gracias!",
...
while 1 == 1:
    ...
    try:
        ...
        shensu.main(
            "虎", site, reason, "D:\\Google\\Google_hu\Chrome\\Application\\chrome.exe"
        )
        time.sleep(600)
