...
list_mx = [
    "#2180745765#2173652393 Dear customer service, this is a generic brand just a common game console accessories, I added para to indicate that he is compatible with various game consoles and TV connection accessories, was misjudged as an infringement, please help me to eliminate the impact of the",
...
list_br = [
    "5168421550, 3903684325 Estimado servicio al cliente, estas dos son consolas de marca genérica, creo que es un error de apreciación del sistema, por favor ayúdenme a borrar el registro de infracción, ¡gracias!"
]
