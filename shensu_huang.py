...
list_br = [
    "2000009679160604 Estimado cliente, es el equipo del cliente el que no es compatible con mi producto, esto no prueba que mi producto tenga un problema de calidad, por favor, elimine el impacto sobre mi reputación."
]
