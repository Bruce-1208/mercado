...
list_cl = [
    "2771166216, 2771153644, 2771166214, 2771244054, 2771192146, 2771076458, 1499498557 Estimado servicio de atención al cliente, son todos productos sin marca, que fueron detectados por el sistema por error, por favor ayúdenme a eliminar el registro de infracción."
]
list_co = [
    "co#2000006402166451 Estimado servicio al cliente, el cliente no será capaz de utilizar el producto correctamente, para ayudarle a resolver el problema no se comunica, directamente abrir el intermediario, obviamente, para la compra libre, ¿me puede ayudar a eliminar el impacto en mi reputación",
