...
list_mx = [
    "2000009661171418 Estimado Servicio de Atención al Cliente, El cliente no tiene pruebas de que mi producto sea defectuoso, creo que sólo quiere una razón para comprar gratis y molestarse en eliminar el impacto en mi reputación."
]
list_br = []
