...
# 1. 准备 Token
MY_ACCESS_TOKEN = (
    "APP_USR-2845198883767774-042309-3009ff51e058a9ffd566beb335812bd9-1742669993"
)
...
payload = {
    "sites_to_sell": [
        {
            ...
            "title": "Cosplay De Halloween De Luffy Girasol De One Piece",
            "net_proceeds": 7,
        }
    ],
    "condition": "new",
    ...
    "attributes": [
        {
            ...
            "values": [
                {"id": "", "name": "10 cm", "struct": {"number": 10, "unit": "cm"}}
            ],
        },
        {
            "id": "PACKAGE_WIDTH",
        ...
        },
        {
            ...
            "value_struct": None,
            "values": [{"id": "", "name": "7899041798600", "struct": None}],
        },
        {
            "id": "PACKAGE_LENGTH",
            ...
            "value_id": "",
            "value_name": "2 cm",
            "value_struct": {"number": 2, "unit": "cm"},
            "values": [
                {"id": "", "name": "2 cm", "struct": {"number": 2, "unit": "cm"}}
            ],
        },
        {
        ...
        },
        {
            ...
            "values": [
                {"id": "", "name": "186 g", "struct": {"number": 186, "unit": "g"}}
            ],
        },
        {
            "id": "SELLER_SKU",
            ...
            "value_struct": None,
            "values": [{"id": "", "name": "330196107-ASSHOW-XS", "struct": None}],
        },
    ],
    ...
    "pictures": [{"source": "https://http2.mlstatic.com/D_647917.jpg"}],
}
