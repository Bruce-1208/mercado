...
def post_mercado(dict):
    ACCESS_TOKEN = (
        "APP_USR-8820539028080485-090307-8daa208dac330a12e1b10e5cb4e3cfa2-1597635622"
    )
    ...
    data["attributes"] = [
        ...
        },
        {
            ...
            "value_id": "",
            "value_name": "3.5 K",
            "value_struct": {"number": 3.5, "unit": "K"},
            "values": [
                {"id": "", "name": "3.5 K", "struct": {"number": 3.5, "unit": "K"}}
            ],
        },
        {
            "id": "GTIN",
            ...
            "value_struct": None,
            "values": [{"id": "", "name": gtin_code, "struct": None}],
        },
        {
            "id": "INCLUDES_BULBS",
        ...
        },
        {
            ...
            "value_name": "Branco",
            "value_struct": None,
            "values": [{"id": "52055", "name": "Branco", "struct": None}],
        },
        {
            ...
            "value_name": "LED",
            "value_struct": None,
            "values": [{"id": "7387210", "name": "LED", "struct": None}],
        },
        {
            "id": "MODEL",
            "name": "Modelo",
        ...
        },
        {
            ...
            "value_name": "Teto",
            "value_struct": None,
            "values": [{"id": "7720909", "name": "Teto", "struct": None}],
        },
        {
            "id": "PACKAGE_HEIGHT",
            ...
            "values": [
                {"id": "", "name": "20 cm", "struct": {"number": 20, "unit": "cm"}}
            ],
        },
        {
            "id": "PACKAGE_LENGTH",
        ...
        },
        {
            ...
            "value_id": "",
            "value_name": "690 g",
            "value_struct": {"number": 690, "unit": "g"},
            "values": [
                {"id": "", "name": "690 g", "struct": {"number": 690, "unit": "g"}}
            ],
        },
        {
            "id": "PACKAGE_WIDTH",
        ...
        },
        {
            ...
            "value_id": "",
            "value_name": "9 W",
            "value_struct": {"number": 9, "unit": "W"},
            "values": [{"id": "", "name": "9 W", "struct": {"number": 9, "unit": "W"}}],
        },
        {
            "id": "SELLER_SKU",
            "name": "SKU",
            ...
            "value_struct": None,
            "values": [{"id": "", "name": "MLB5534170542", "struct": None}],
        },
        {
            "id": "UNITS_PER_PACK",
        ...
        },
        {
            ...
            "value_name": "220V",
            "value_struct": None,
            "values": [{"id": "198813", "name": "220V", "struct": None}],
        },
        {
            "id": "WITH_PUSH_BUTTON",
    ...
    response = requests.post(
        "http://api.mercadolibre.com/global/items", headers=headers, data=data_json
    )
    print(response.json())
...
if __name__ == "__main__":
    post_picture(
        "http://vibktprfx-prod-prod-damo-eas-cn-shanghai.oss-cn-shanghai.aliyuncs.com/seg-common-image/2025-09-03/fd91e55a-bb06-43eb-aa6f-330bb9b0f6ac/image.jpg?Expires=1756906583&OSSAccessKeyId=LTAI4FoLmvQ9urWXgSRpDvh1&Signature=ImUkUi5%2BmyN9kFqXUlXuCRwfQgE%3D",
