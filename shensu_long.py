...
while 1 == 1:
    ...
    try:
        ...
        shensu.main(
            ...
            site,
            reason,
            "D:\\Google\\Google_long\Chrome\\Application\\chrome.exe",
        )
        time.sleep(1800)
