...
# ]
list_br = [
    "3780919813，3780881733 Estimado Servicio de Atención al Cliente, El producto es un producto genérico de marca, él sólo es compatible con PSP, creo que esto es un error de apreciación del sistema, ¿pueden ayudarme a eliminar el registro de infracción?"
]
