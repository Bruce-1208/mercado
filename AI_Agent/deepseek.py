...
def get_ai_response(message):
    client = OpenAI(
        api_key="sk-0fe4cfd1aabd4256b66ccfffa47ace96",
...
if __name__ == "__main__":
    get_ai_response(
        """亲爱的客服，我叫布鲁斯，因为菜鸟没有及时揽收我的物流，对我店铺声誉造成了影响，我总结了下面这些订单，你能帮我消除对我声誉的影响吗？
...
我理解这种情况令人沮丧，尤其是当你按时完成发货，但问题出在Cainiao扫描的外部因素上。为了确保我理解正确：你是否需要我们分析这些特定订单，让相关团队评估是否有可能减轻因扣留而对你的声誉造成的损害？"""
        + "|这段对话是我跟美客多客服的对话，我叫布鲁斯，麻烦您帮我简单自然的回复一下他，返回不超过10个字"
    )
