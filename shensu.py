        ...
        def zhaokefu():
            try:
                ...
                chrome_options.add_argument(
                    "disable-features=AutofillEnableAutocompleteName,AutofillEnableProfileName"
                )
                ...
                try:
                    driver.get(
                        "https://global-selling.mercadolibre.com/help/chat/v2?hasCreditRestriction=false"
                    )
                    time.sleep(10)
                    ...
                    driver.find_element(
                        By.XPATH,
                        "/html/body/div[3]/div/div/div[2]/div[3]/div[2]/button/span",
                    ).click()
                ...
                if (
                    ...
                    mlm = (
                        "/html/body/header/div/div/div[1]/div/div[2]/div/div[2]/div[2]"
                    )
                    mlb = (
                        "/html/body/header/div/div/div[1]/div/div[2]/div/div[2]/div[3]"
                    )
                    mlc = (
                        "/html/body/header/div/div/div[1]/div/div[2]/div/div[2]/div[4]"
                    )
                    mco = (
                        "/html/body/header/div/div/div[1]/div/div[2]/div/div[2]/div[5]"
                    )
                ...
                try:
                    ...
                    driver.find_elements(By.CLASS_NAME, "andes-button__content")[
                        0
                    ].click()
                ...
                if type(reason) != list:
                    ...
                    element_in_iframe = driver.find_element(
                ...
                element_in_iframe = driver.find_element(
                    ...
                    "Estimado Servicio de Atención al Cliente, Me llamo Bruce. Me alegro de ser tu amigo,¡espero que puedan ayudarme y espero sus buenas noticias!"
                )
                # 操作完成后，切换回主文档
                driver.switch_to.default_content()
                time.sleep(5)
