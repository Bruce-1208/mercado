...
list_br = [
    "3892137819 Estimado servicio de atención al cliente, se trata de un producto de marca genérica, creo que se trata de un error de apreciación del sistema, por favor ayúdeme a eliminar el registro de infracción.",
...
list_cl = [
    "2000009165447004 Estimado servicio de atención al cliente, el cliente no tiene ninguna prueba de problemas de calidad con mis productos, sospecho que está intentando comprar gratis, por favor, elimine el impacto en mi reputación.",
...
while 1 == 1:
    ...
    try:
        ...
        shensu.main(
            ...
            site,
            reason,
            "D:\\Google\\Google_teng\Chrome\\Application\\chrome.exe",
        )
        time.sleep(600)
