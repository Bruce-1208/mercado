...
list_mx = [
    "2000009620547890 Estimado servicio de atención al cliente, me he ofrecido a reembolsar íntegramente al cliente, por favor, elimine el impacto en mi reputación.",
...
list_br = [
    "3858326707 Dear customer service, this is a generic brand product, he is just a phone case compatible with iphone, I think this is a system misjudgment, please help me to delete the infringement records",
...
list_cl = []
list_co = [
    "1477107967,1477155977  Estimado servicio al cliente, todos son productos sin marca, que fueron detectados erróneamente por el sistema, por favor ayúdeme a eliminar el registro de infracción."
]
